  ...
  return (
    <div style={{ padding: '3rem', minHeight: '100vh' }}>
      <header style={{ marginBottom: '2rem' }}>
        <h1 className="gradient-text" style={{ fontSize: '3rem', fontWeight: 900 }}>ADMIN &gt; DISTRIBUTORS</h1>
      ...
      <div className="premium-card">
        ...
        <p style={{ opacity: 0.8, lineHeight: 1.6 }}>
          Esta es la página principal del módulo: <strong>admin/distributors</strong>.
