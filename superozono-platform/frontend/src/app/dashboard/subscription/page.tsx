  ...
  return (
    <div style={{ padding: '3rem', minHeight: '100vh' }}>
      <header style={{ marginBottom: '2rem' }}>
        <h1 className="gradient-text" style={{ fontSize: '3rem', fontWeight: 900 }}>DASHBOARD &gt; SUBSCRIPTION</h1>
      ...
      <div className="premium-card">
        ...
        <p style={{ opacity: 0.8, lineHeight: 1.6 }}>
          Esta es la página principal del módulo: <strong>dashboard/subscription</strong>.
        ...
        <div style={{ marginTop: '2.5rem', display: 'flex', gap: '1rem' }}>
          ...
          <div style={{ padding: '1rem', background: 'rgba(255,255,255,0.05)', borderRadius: '8px', border: '1px dashed var(--border)', flex: 1 }}>
            ...
            Status: /api/dashboard-subscription
          </div>
        </div>
      </div>
    </div>
